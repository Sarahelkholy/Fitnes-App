...
class UserBasicInfoBlocListener extends StatelessWidget {
  const UserBasicInfoBlocListener({super.key});
        ...
        state.whenOrNull(
          ...
          basicInfoAdded: () {
            context.pushReplacementNamed(
              Routes.addUserPhysicalInfoScreen,
